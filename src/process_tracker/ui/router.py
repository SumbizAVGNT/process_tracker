...
def handle_route_change(page: ft.Page) -> None:
    ...
    Если при построении страницы происходит ошибка — логируем и пробрасываем исключение,
    чтобы стек был виден в консоли Python.
    """
    route = page.route or "/"
    try:
        ...
        logger.exception("ui_route_error", route=route)
        raise
